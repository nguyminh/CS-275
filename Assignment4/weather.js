...
function GetAll() {
  ...
  if (this.readyState === 4 && this.status == 200) {
	...
	document.getElementById('cityOUT').innerHTML = document.getElementById('cityID').value;
    document.getElementById('stateOUT').innerHTML = document.getElementById('stateID').value;
 	
	if (document.getElementById('check1').checked == true) {
	document.getElementById('windDIR').innerHTML = winddi;
	} else {
	document.getElementById('windDIR').innerHTML = "No information requested";
	}
	
	if (document.getElementById('check1').checked == true) {
	document.getElementById('windSPD').innerHTML = windsp + ' mph';
	} else { 
	document.getElementById('windSPD').innerHTML = "No information requested";
	}
	
	if (document.getElementById('check2').checked == true) {
	document.getElementById('minOUT').innerHTML = mint + ' degrees fahrenheit';
	} else {
	document.getElementById('minOUT').innerHTML = "No information requested";
	}
	
	if (document.getElementById('check3').checked == true) {
	document.getElementById('maxOUT').innerHTML = maxt + ' degrees fahrenheit';
	} else { 
	document.getElementById('maxOUT').innerHTML = "No information requested";
	}
	
	if (document.getElementById('check4').checked == true) {
	document.getElementById('currOUT').innerHTML = currt + ' degrees fahrenheit';
	} else { 
	document.getElementById('currOUT').innerHTML = "No information requested";
	}
  }
  REQ.open('GET', url);
  REQ.send();
